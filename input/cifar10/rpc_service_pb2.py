...
_TUPLE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='threshold_to_quantize', full_name='adaptive_system.Tuple.threshold_to_quantize', index=13,
